...
| 8 | Spanish catalog | ✅ done — all 208 changed/new strings hand-translated (Colombian, informal *tú*, per glossary). 0 fuzzy / 0 untranslated. Tooling (`scripts/translate_po.py` + glossary) is in place for future string changes; see `docs/translations.md`. |
